                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (username.trim().length() > 0 && password.trim().length() > 0) {
                            if (dataSnapshot.hasChild(username)) {
                                alert.showAlertDialog(LoginActivity.this, "Registration failed..", "Username is already registered, please change one.", false);
//                                Toast.makeText(getBaseContext(),"Username is already registered, please change one", Toast.LENGTH_SHORT).show();
                            ...
                            alert.showAlertDialog(LoginActivity.this, "Registration failed..", "Please input valid username or password and try again!", false);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (username.trim().length() > 0 && password.trim().length() > 0) {
                            if (dataSnapshot.hasChild(username) && (password.equals(dataSnapshot.child(username).child("password").getValue()))) {
                                ...
                                alert.showAlertDialog(LoginActivity.this, "Login failed..", "Incorrect Username/Password", false);
//                                Toast.makeText(getBaseContext(),"Incorrect username or password. Please try again or register.", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            alert.showAlertDialog(LoginActivity.this, "Login failed..", "Please input valid username or password and try again!", false);
//                            Toast.makeText(getBaseContext(),"Please input valid username or password and try again!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
